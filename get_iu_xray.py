...
with open("E:\pHD\data\iu_xray\iu_xray.tsv", "w") as output_file:
    for image_caption in images_captions:
        output_file.write(image_caption + "\t" + images_captions[image_caption])
        output_file.write("\n")

# Safer JSON storing
with open("E:\pHD\data\iu_xray\iu_xray_captions.json", "w") as output_file:
    output_file.write(json.dumps(images_captions))
with open("E:\pHD\data\iu_xray\iu_xray_major_tags.json", "w") as output_file:
    output_file.write(json.dumps(images_major_tags))
with open("E:\pHD\data\iu_xray\iu_xray_auto_tags.json", "w") as output_file:
...
train_path = r"E:\pHD\data\iu_xray\train_images.tsv"
test_path = r"E:\pHD\data\iu_xray\test_images.tsv"
